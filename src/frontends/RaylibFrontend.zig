...
pub fn init(allocator: std.mem.Allocator, opts: anytype) !RaylibFrontend {
    ...
    const pixels = try allocator.alloc(u8, State.display_width * State.display_height * 3);
...
pub fn deinit(self: RaylibFrontend) void {
...
pub fn shouldStop(_: RaylibFrontend) bool {
...
fn waitForTargetFPS(self: *RaylibFrontend) void {
...
fn takeScreenshot(self: *RaylibFrontend) void {
